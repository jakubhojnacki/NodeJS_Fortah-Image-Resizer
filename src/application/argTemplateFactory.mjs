...
export class ArgTemplateFactory extends ArgTemplateFactoryBase {
    create() { 
        ...
        argTemplates.insert([
            new ArgTemplate(0, ArgName.source, "Source directory", DataType.string, true),
            ...
            new ArgTemplate([ "sfm", "sourceFileMask" ], ArgName.sourceFileMask, "Source file mask", DataType.string, true),
